...
export default function BenefitsBanner() {
    ...
    return (
        <>
            <section className="site-banner benefits-banner about-banner event-banner relative bg-cover xl:min-h-[800px] md:min-h-[500px] xs:min-h-[400px] small:min-h-[300px] flex items-center small:pb-0 xs:pb-10 lg:bg-center bg-center">
