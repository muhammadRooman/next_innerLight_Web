                ...
                <div className="bg-white xl:pt-[130px] xl:pb-[126px] lg:pt-[90px] lg:pb-[90px] py-10">
                    <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-5">
                        <div>
                            ...
                            <p className="lg:text-lg text-sm xl:text-lg rtl:2xl:text-[30px] rtl:md:text-[28px] font-normal xl:mb-7 mb-5 rtl:flex rtl:items-start rtl:justify-start rtl:flex-col md:leading-[32px] small:leading-[20px] sportive_content">
                            ...
                            <p className="lg:text-lg text-sm xl:text-lg rtl:2xl:text-[30px] rtl:md:text-[28px] font-normal md:mb-7 xs:mb-5  small:mb-0 rtl:flex rtl:items-start rtl:justify-start rtl:flex-col md:leading-[32px] small:leading-[20px] sportive_content">
