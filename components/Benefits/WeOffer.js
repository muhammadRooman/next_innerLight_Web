        ...
        <>
            <section>
                <div class="bg-white xl:pt-[130px] xl:pb-[126px] lg:pt-[90px] lg:pb-[90px] py-10">
                    <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-5">
                        <div>
                            <div class="heading-box text-left rtl:text-right lg:pb-6 md:pb-0 pb-0 what_we_offer">
