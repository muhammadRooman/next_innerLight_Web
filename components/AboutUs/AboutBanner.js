            ...
            <div className="2xl:container xl:container lg:container md:container xs:container md:mx-auto lg:max-0 px-5">
                <div className="inner-container relative sm:pt-4 md:pt0">
                    <div className="site-banner-content about_banner_content max-w-[582px] ml-0 rtl:text-right"> 
                        <h1 className="xl:text-40 lg:text-[30px] md:text-[25px] text-[18px] lg:leading-[50px] md:leading-[40px] xs:leading-[30px] leading-5 text-info-color font-bold text-left rtl:md:text-[70px] rtl:xs:text-[40px] rtl:small:text-[30px] rtl:md:leading-[86px] rtl:xs:leading-[40px] rtl:small:leading-[25px] rtl:text-right">{t("who_we_are")}</h1>  
