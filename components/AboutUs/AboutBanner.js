            ...
            <div className="2xl:container xl:container lg:container md:container xs:container mx-auto lg:max-0  px-5">
                <div className="inner-container relative sm:pt-4 md:pt0">
                    <div className="site-banner-content max-w-[582px] ml-0 rtl:text-right"> 
                        ...
                        <Link href="https://play.google.com/store/apps/details?id=com.arhamsoft.innerlight.innerlights&hl=en" className="py-[7px] px-[20px] xs:py-[12px] xs:px-[30px] md:py-[14px] md:px-[45px] lg:py-[17px] lg:px-[55px] text-white rounded-3xl font-medium bg-btn-gradient hover:bg-btn-gradient-hover">{t("download_app")}</Link>
                        </div>
                    </div>   
                </div>
            </div>
