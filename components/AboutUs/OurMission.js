                ...
                <div className="md:grid md:grid-cols-12 aboutUs gap-6 "> 
                    <div className="col-span-8">
                        <div className="heading-box text-left rtl:text-right mb-5">
                            <h5 className="text-info-color 2xl:text-2xl md:text-[20px] xs:text-[18px] small:text-[16px] 2xl:leading-[30px] font-black rtl:2xl:text-[56px] rtl:xl:text-[40px] rtl:text-[30px] our_mission_heading">{t("about_us")}</h5>
                        ...
                        <p className='lg:text-lg xl:text-[24px] md:text-[16px] text-[14px] rtl:2xl:text-[30px] rtl:md:text-[28px] font-normal text-[#343434] our_mission_custom_font'>{t("we_believe_that_true")}</p>
                        <p className='lg:text-lg xl:text-[24px] md:text-[16px] text-[14px] rtl:2xl:text-[30px] rtl:md:text-[28px] font-normal mt-4 text-[#343434] our_mission_custom_font_bold'>{t("through_our_teachings")}</p> 
                        <p className='lg:text-lg xl:text-[24px] md:text-[16px] text-[14px] rtl:2xl:text-[30px] rtl:md:text-[28px] font-normal mt-5 text-[#343434] our_mission_custom_font'>{t("we_are_committed")}</p>  
                    </div>
