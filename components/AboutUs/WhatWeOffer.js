    ...
    <section className="WhatWeOffer xl:pt-[107px] rtl:xl:pt-[60px] pb-12 pt-[50px] bg-SubscriptionPlan-bg bg-cover">
      <div className="2xl:container xl:container lg:container md:container mx-auto lg:max-0 px-5">
        <div className="heading-box text-center lg:mb-20 md:mb-20 mb-10 xl:max-w-[1087px] md:max-w-[800px] max-w-[100%] ms-auto me-auto">
          ...
          <p className="text-lg xl:text-2xl md:max-w-[950px] rtl:xl:text-[40px] rtl:max-w-[950px] rtl:mx-auto rtl:xl:leading-10 font-normal mb-4 mt-5 m-auto font_40">{t("experience_personalized")}</p>
        </div>
        <div className="grid xl:grid-cols-3 md:grid-cols-3 xs:grid-cols-2 small:grid-cols-1 gap-7 lg:mt-28 min-h-[430px] our_service_height">
          {offerings.map((offering, index) => (
            ...
            >
              ...
              <div className="WhatWeOffer-content lg:p-6 p-5">
                ...
                <div className="hide-content max-h-0 overflow-hidden transition-[max-height] duration-300 ease-in-out group-hover:max-h-48 custom_overflow">
                  <p className="lg:text-lg text-sm xl:text-lg rtl:2xl:text-[30px] rtl:md:text-[28px] font-normal mt-4 font_32">{offering.description}</p>
                </div>
              </div>
            </div>
          ))}
