                ...
                <div className="2xl:container xl:container lg:container md:container mx-auto lg:max-0 px-5"> 
                    <div className="grid md:grid-cols-12 gap-5"> 
                        <div  className="col-span-7 our-value-inner">
                            ...
                            <p className="lg:text-lg text-sm xl:text-lg rtl:2xl:text-[30px] rtl:md:text-[28px] font-normal rtl:max-w-[680px] rtl:leading-8 mb-4 custom_font font_32"><span className="text-info-color 2xl:text-2xl md:text-[20px] xs:text-[18px] small:text-[16px] 2xl:leading-[30px] font-black rtl:2xl:text-[56px] rtl:xl:text-[40px] rtl:text-[30px] heading_40 block"> {t("mindfulness_&_presence")}</span> {t("we_listen_with_open")}</p>
                            </div>
