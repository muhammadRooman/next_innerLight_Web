            ...
            <section className="site-banner contact-banner relative bg-cover xl:min-h-[800px] md:min-h-[500px] xs:min-h-[400px] small:min-h-[300px] flex items-center small:pb-0 xs:pb-10 lg:bg-center bg-center">
                <div className="2xl:container xl:container lg:container md:container xs:container md:mx-auto lg:max-0 px-5">
                    <div className="site-banner-content max-w-[590px] rtl:max-w-[725px] ml-0"> 
                            <h1 className="xl:text-40 lg:text-[30px] md:text-[25px] text-[18px] lg:leading-[50px] md:leading-[40px] xs:leading-[30px] leading-5 text-info-color font-bold text-left rtl:md:text-[70px] rtl:xs:text-[40px] rtl:small:text-[30px] rtl:md:leading-[86px] rtl:xs:leading-[40px] rtl:small:leading-[25px] rtl:text-right">{t("contact_us")}</h1>  
