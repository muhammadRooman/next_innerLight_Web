            ...
            <div className="2xl:container xl:container lg:container md:container xs:container md:mx-auto lg:max-0 px-5">
                <div className="inner-container relative sm:pt-4 md:pt0">
                    <div className="site-banner-content max-w-[600px] rtl:max-w-[725px] ml-0">
                        <h1 className="xl:text-40 lg:text-[30px] md:text-[25px] text-[18px] lg:leading-[50px] md:leading-[40px] xs:leading-[30px] leading-5 text-info-color font-bold text-left rtl:md:text-[70px] rtl:xs:text-[40px] rtl:small:text-[30px] rtl:md:leading-[86px] rtl:xs:leading-[40px] rtl:small:leading-[25px] rtl:text-right">{t("events")}</h1>
                        <h5 className="xl:text-50 lg:text-[40px] md:text-[30px] text-[20px] md:max-w-[599px] xs:max-w-[400px] small:max-w-[300px] rtl:lg:max-w-[725px] rtl:md:max-w-[525px] rtl:xs:max-w-[340px] rtl:small:max-w-[190px] text-white font-bold text-left rtl:lg:text-[80px] rtl:md:text-[60px] rtl:xs:text-[40px] rtl:small:text-[24px] xl:leading-[63px] lg:leading-[46px] rtl:text-right rtl:md:leading-[70px] rtl:xs:leading-[45px] rtl:small:leading-[30px] mb-4">{t("pathway_to_inner_peace")}</h5>
                        <p className="text-left text-white 2xl:text-2xl md:text-[20px] xs:text-[16px] small:text-[14px] xl:max-w-[580px] md:max-w-[490px] max-w-[350px] rtl:2xl:text-[40px] rtl:md:text-[30px] rtl:xs:text-[20px] rtl:small:text-[18px] rtl:leading-[40px] rtl:text-right mt-5">{t("through_holistic_practices")}</p>
