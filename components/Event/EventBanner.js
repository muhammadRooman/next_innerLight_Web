            ...
            <div className="2xl:container xl:container lg:container md:container xs:container mx-auto lg:max-0 px-5">
                <div className="inner-container relative sm:pt-4 md:pt0">
                    <div className="site-banner-content max-w-[600px] rtl:max-w-[725px] ml-0">
                        <h1 className="xl:text-40 lg:text-[30px] md:text-[25px] text-[18px] lg:leading-[50px] md:leading-[40px] xs:leading-[30px] leading-5 text-info-color font-bold text-left rtl:xl:text-[70px] rtl:leading-[86px] rtl:text-right">{t("events")}</h1>
                        <h5 className="xl:text-50 lg:text-[40px] md:text-[30px] text-[20px] md:max-w-[599px] xs:max-w-[400px] small:max-w-[300px] text-white font-bold text-left rtl:text-[80px] rtl:leading-[99px] rtl:text-right xl:leading-[63px] lg:leading-[46px] mb-4">{t("pathway_to_inner_peace")}</h5>
